...
public class StakeTest {
    ...
    private static BetOffer mockBetOffer(int cnt) {
        BetOffer mockBetOffer = new BetOffer(new Stake(0, 0));
        for (int i = 1; i <= cnt; i++) {
            mockBetOffer.addStake(new Stake(i, +i));
        }
        return mockBetOffer;
    }
